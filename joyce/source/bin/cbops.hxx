...
// [JCE 24-3-2002] Don't store() when just testing a bit. For a RAM or ROM
// this doesn't matter, but it upsets the delicate mechanism of a Flash chip.
