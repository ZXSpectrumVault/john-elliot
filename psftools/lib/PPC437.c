 ...
 * table ppc437.uni in the format used by the Linux kbd package */

/*  PPC512: Codepage 437. Identical to the normal codepage 437, except that  */
/*  character 0xEE has been changed from Epsilon (U+03B5) to Element-Of (U+2208). */
/*  This is because the PPC512 contains a proper Epsilon in its Greek character */
/*  set and I don't want them conflated. */
#include <stdio.h>
#include "psflib.h"
...
struct psf_mapping256 m_PPC437 = { "PPC437",
256, {
&values[1], /* 0  */
&values[3], /* 1  */
&values[5], /* 2  */
